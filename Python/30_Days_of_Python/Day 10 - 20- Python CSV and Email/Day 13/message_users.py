...
obj = MessageUser()
obj.add_user("Ceara", 123.32, email='email@gmail.com')
obj.add_user("Yuri", 94.23, email='email@gmail.com')
obj.add_user("Christian", 93.23, email='email@gmail.com')
obj.add_user("Julia", 193.23, email='email@gmail.com')
